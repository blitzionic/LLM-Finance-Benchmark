...
class ReviewerAgent(Agent):
    ...
    def process(self, question, previous_model_answer):
        prompt = (
            ...
            "Select one letter (A, B, C, or D) as your final answer and provide your expert reasoning for that choice. If your answer differs from"
            "the inital answer, explain why."
        )
        print(f"REVIEWER PROCESSING PROMPT: {prompt}")
